 ...
 public:
  ...
  void Tester(const ArrayGenerator& generator, const std::string& result) {
    ...
    for (int size = 500; size <= max_size; size += 100) {
      ...
      out << size << "\t";
      out << Time(randomArray, mergeSort) << "\t";
      out << Time(reversedArray, mergeSort) << "\t";
      out << Time(almostSortedArray, mergeSort) << "\t";
      out << Time(randomArray, hybridMergeSort) << "\t";
      out << Time(reversedArray, hybridMergeSort) << "\t";
      out << Time(almostSortedArray, hybridMergeSort) << "\n";
    }
...
int main() {
  ...
  ArrayGenerator generator(max_size, 0, 600);
  SortTester test;
